...
//************************IMU Structure Code***************************************
int Get_IMU (IMU_s *pIMUs, bool DebugSerialMonitor) //Preenche uma structure de IMU
{
  //Variáveis do BMP
...
if (DebugSerialMonitor) 
{
  ...
  Serial.print(F("Acelerometro em m/s2 : "));
  Serial.print(F("x : "));
  ...
  Serial.print(F("Giroscopio em m/s : "));
  Serial.print(F("x : "));
  ...
  Serial.print(F("Pressao em Pa : "));
  Serial.print(pIMUs->barometro[0]);
  Serial.print(F("  Altitude em Metros: "));
  Serial.print(pIMUs->barometro[1]);
  Serial.print(F("  Temperatura em Celsius: "));
  Serial.println(pIMUs->barometro[2]);
  Serial.println();
  if(pIMUs->barometro[0] == 0) {
  return 1;
}
  else {
  return 0;
