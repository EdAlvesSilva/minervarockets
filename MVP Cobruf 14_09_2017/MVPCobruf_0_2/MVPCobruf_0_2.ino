...
void loop() {  
  ...
  if (myFile) {
    ...
    myFile.print(pGPSs1->flat);myFile.print(F(" ,"));
    myFile.print(pGPSs1->flon);myFile.print(F(" ,"));
  ...
  if (DebugSDSerial) {
    ...
    Serial.print(pGPSs1->flat);Serial.print(F(" ,"));
    Serial.print(pGPSs1->flon);Serial.print(F(" ,"));
